...
/*jshint -W083 */
	...
	$.jstree.core.prototype = {
		 ...
		 */
		refresh : function (skip_loading, forget_state, msg) {
 ...
 */
	...
	$.jstree.plugins.changed = function (options, parent) {
		...
		this.refresh = function (skip_loading, forget_state, msg) {
			last = [];
			...
			return {
				"create" : {
					...
					"action"			: function (data) {
						...
						inst.refresh(false,false,"create");
					}
				},
				"rename" : {
					"separator_before"	: false,
					...
					*/
					"action"			: function (data) {
						var inst = $.jstree.reference(data.reference),
							obj = inst.get_node(data.reference);
						//inst.edit(obj);
						inst.refresh(false,false,"rename");
					}
				},
				"remove" : {
					"separator_before"	: false,
					...
					"action"			: function (data) {
						...
						if(inst.is_selected(obj)) {
							...
							//Mine
							inst.refresh(false,false,"delete");
						}
						else {
					...
					"submenu" : {
						...
						"paste" : {
							...
							"action"			: function (data) {
								...
								inst.refresh(false,false,"paste");
							}
						}
					}
				}
 ...
 */
	...
	$.jstree.plugins.types = function (options, parent) {
		...
		this.refresh = function (skip_loading, forget_state, msg) {
			parent.refresh.call(this, skip_loading, forget_state, msg);
			this._model.data[$.jstree.root].type = $.jstree.root;
		};
		this.bind = function () {
			this.element
